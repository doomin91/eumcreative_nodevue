      ...
      <el-form ref="form" :model="searchForm" label-width="120px" label-padding-right="20px">
        <div class="blockbase block-rounded">
          <div class="block-header">
            <h3 class="block-title">장기미사용 정책현황</h3>
          </div>
                    ...
                    <el-col :span="12">
                        <el-row>
                          ...
                          <el-col :span="18">
                            <el-row :gutter="10">
                              <el-col>
                                <el-radio-group v-model="searchForm.unused_day">
...
<script>
  ...
  export default {
   ...
   components: {
    ...
    methods: {
      goViewPage(item){
        this.$router.push({path:"/policyUnusedStatusView", query:{deviceId:item.device_id, policyNumber:item.policy_number}});
      },
      setPage (val) {
        this.page = val
      },
      ...
      getDataLoad() {
        this.polices = [];
        this.searchForm.unused_day = parseInt(this.searchForm.unused_day)
        collectApi.getUnusedPolicy(this.searchForm)
          .then(res => {
